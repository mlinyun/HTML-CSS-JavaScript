...
function matched() {
    ...
    opendCards[0].classList.remove('show', 'open', 'no-event')
    opendCards[1].classList.remove('show', 'open', 'no-event')
    opendCards = []
}
...
function unmatched() {
    ...
    disable()
    setTimeout(function() {
        opendCards[0].classList.remove('show', 'open', 'no-event', 'unmatched')
        opendCards[1].classList.remove('show', 'open', 'no-event', 'unmatched')
        enable()
        opendCards = []
    }, 1100)
}
...
for (let i = 0; i < cards.length; i++) {
    ...
    card.addEventListener('click', carOpen)
